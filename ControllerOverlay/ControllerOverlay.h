...
#define GREY      ImColor(120, 120, 120, 255)
#define DARKGREY  ImColor(45, 45, 45, 255)
...
public:
        ...
        // 	std::string configurationFilePath = std::string(BAKKESMOD_DIR) +
        // "/cfg/controlleroverlay.cfg";
        std::string configurationFilePath =
                gameWrapper->GetBakkesModPath().string() +
                "/cfg/controlleroverlay.cfg";
